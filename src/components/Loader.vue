<template>
  <div class="relative h-full flex flex-col items-center justify-center">
    <div class="ephemeris relative h-24 w-24 flex items-center justify-center">
      <img
        class="w-full absolute rotate-[143deg] animate-golden-ring-1"
        src="/images/GoldenRingUp.svg"
        alt="Gold ephemeris ring up"
      />
      <img
        class="w-full absolute rotate-[150deg] animate-golden-ring-2"
